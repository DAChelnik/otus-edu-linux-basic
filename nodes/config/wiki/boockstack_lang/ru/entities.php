...
return [
    ...
    'recently_created_books' => 'Недавно созданные инструкции',
    'recently_created_shelves' => 'Недавно созданные разделы',
    ...
    'permissions_book_cascade' => 'Разрешения, установленные для инструкции, автоматически распространяются на дочерние главы и страницы, если для них не определены собственные разрешения.',
    ...
    'shelf' => 'Раздел',
    'shelves' => 'Разделы',
    'x_shelves' => ':count раздел|:count разделы|:count полок',
    'shelves_empty' => 'Разделы не созданы',
    'shelves_create' => 'Создать новый раздел',
    'shelves_popular' => 'Популярные разделы',
    'shelves_new' => 'Новые разделы',
    'shelves_new_action' => 'Новый раздел',
    'shelves_popular_empty' => 'Популярные разделы появятся здесь.',
    'shelves_new_empty' => 'Последние созданные разедлы появятся здесь.',
    'shelves_save' => 'Сохранить раздел',
    'shelves_books' => 'Инструкции из этого раздела',
    'shelves_add_books' => 'Добавить инструкцию в этот раздел',
    'shelves_drag_books' => 'Перетащите инструкции ниже, чтобы добавить их в этот раздел',
    'shelves_empty_contents' => 'В этом разделе нет инструкций',
    'shelves_edit_and_assign' => 'Изменить раздел для привязки инструкции',
    'shelves_edit_named' => 'Редактировать раздел :name',
    'shelves_edit' => 'Редактировать раздел',
    'shelves_delete' => 'Удалить раздел',
    'shelves_delete_named' => 'Удалить раздел :name',
    'shelves_delete_explain' => "Это приведет к удалению раздела с именем ':name'. Привязанные инструкции удалены не будут.",
    'shelves_delete_confirmation' => 'Вы уверены, что хотите удалить раздел?',
    'shelves_permissions' => 'Доступы к разделу',
    'shelves_permissions_updated' => 'Доступы к разделу обновлены',
    'shelves_permissions_active' => 'Действующие разрешения раздела',
    'shelves_permissions_cascade_warning' => 'Разрешения на раздел не наследуются автоматически содержащимся в них инструкциям. Это происходит потому, что инструкция может находиться на нескольких разделах. Однако разрешения могут быть установлены для инструкций раздела с помощью опции, приведенной ниже.',
    'shelves_copy_permissions_to_books' => 'Наследовать доступы инструкции',
    'shelves_copy_permissions' => 'Копировать доступы',
    'shelves_copy_permissions_explain' => 'Это применит текущие настройки разрешений для этого раздела ко всем инструкциям, содержащимся в ней. Перед активацией убедитесь, что все изменения разрешений этого раздела были сохранены.',
    'shelves_copy_permission_success' => 'Доступы раздела скопированы для :count инструкций',

    // Books
    'book' => 'Инструкция',
    'books' => 'Инструкции',
    'x_books' => ':count инструкция|:count инструкции|:count инструкций',
    'books_empty' => 'Нет созданных инструкций',
    'books_popular' => 'Популярные инструкции',
    'books_recent' => 'Недавние инструкции',
    'books_new' => 'Новые инструкции',
    'books_new_action' => 'Новая инструкция',
    'books_popular_empty' => 'Здесь появятся самые популярные инструкции.',
    'books_new_empty' => 'Здесь появятся самые последние созданные инструкции.',
    'books_create' => 'Создать новую инструкцию',
    'books_delete' => 'Удалить инструкцию',
    'books_delete_named' => 'Удалить инструкцию :bookName',
    'books_delete_explain' => 'Это удалит инструкции с именем \':bookName\'. Все разделы и страницы будут удалены.',
    'books_delete_confirmation' => 'Вы действительно хотите удалить эту инструкцию?',
    'books_edit' => 'Редактировать инструкцию',
    'books_edit_named' => 'Редактировать инструкцию :bookName',
    'books_form_book_name' => 'Название инструкции',
    'books_save' => 'Сохранить инструкцию',
    'books_permissions' => 'Разрешения на инструкцию',
    'books_permissions_updated' => 'Разрешения на инструкцию обновлены',
    'books_empty_contents' => 'Для этой инструкции нет страниц или разделов.',
    'books_empty_create_page' => 'Создать новую страницу',
    'books_empty_sort_current_book' => 'Сортировка текущей инструкции',
    'books_empty_add_chapter' => 'Добавить главу',
    'books_permissions_active' => 'Действующие разрешения инструкции',
    'books_search_this' => 'Поиск в этой инструкции',
    'books_navigation' => 'Навигация по инструкции',
    'books_sort' => 'Сортировка содержимого инструкции',
    'books_sort_desc' => 'Move chapters and pages within a book to reorganise its contents. Other books can be added which allows easy moving of chapters and pages between books.',
    'books_sort_named' => 'Сортировка инструкции :bookName',
    ...
    'books_sort_show_other' => 'Показать другие инструкции',
    ...
    'books_copy' => 'Копировать инструкцию',
    'books_copy_success' => 'Инструкция успешно скопирована',
    ...
    'chapter_sort_book' => 'Сортировать инструкцию',
    ...
    'book_tags' => 'Теги инструкции',
    'shelf_tags' => 'Теги раздела',
    'tag' => 'Тег',
    'tags' =>  'Теги',
    ...
    'tags_assigned_books' => 'Назначено на инструкции',
    'tags_assigned_shelves' => 'Назначено на разделы',
    ...
    'tags_list_empty_hint' => 'Теги можно присваивать через боковую панель редактора страниц или при редактировании сведений о инструкции, главе или разделе.',
    ...
    'profile_not_created_books' => ':userName не создал ни одной инструкции',
    'profile_not_created_shelves' => ':userName не создал ни одного раздела',
    ...
    // Conversions
    'convert_to_shelf' => 'Преобразовать в раздел',
    'convert_to_shelf_contents_desc' => 'Вы можете превратить эту инструкцию в новый раздел с тем же содержимым. Главы, содержащиеся в этой инструкции, будут преобразованы в новые инструкции. Если эта инструкция содержит какие-либо страницы, которых нет в главе, она будет переименована и будет содержать такие страницы, и эта инструкция станет частью нового раздела.',
    'convert_to_shelf_permissions_desc' => 'Любые разрешения, установленные для этой инструкции, будут скопированы в новый раздел и во все новые дочерние инструкции, для которых не применяются собственные разрешения. Обратите внимание, что разрешения на разделы не применяются автоматически к содержимому внутри, как это происходит с инструкциями.',
    'convert_book' => 'Преобразовать инструкцию',
    'convert_book_confirm' => 'Вы уверены, что хотите преобразовать эту инструкцию?',
    'convert_undo_warning' => 'Это не отменяется простым способом.',
    'convert_to_book' => 'Преобразовать в инструкцию',
    'convert_to_book_desc' => 'Вы можете преобразовать эту главу в новую инструкцию с тем же содержанием. Любые разрешения, установленные в этой главе, будут скопированы в новую инструкцию, но любые унаследованные разрешения из родительской инструкции не будут скопированы, что может привести к изменению контроля доступа.',
