...
return [
    ...
    'bookshelf_color' => 'Цвет раздела',
    'book_color' => 'Цвет инструкции',
    ...
    'maint_recycle_bin_desc' => 'Удаленные разделы, инструкции, главы и страницы отправляются в корзину, чтобы они могли быть восстановлены или удалены навсегда. Более старые элементы в корзине могут быть автоматически удалены через некоторое время в зависимости от системной конфигурации.',
    ...
    'role_manage_entity_permissions' => 'Управление правами на все инструкции, главы и страницы',
    'role_manage_own_entity_permissions' => 'Управление разрешениями для собственных инструкциий, глав и страниц',
    ...
    'role_asset_desc' => 'Эти разрешения контролируют доступ по умолчанию к параметрам внутри системы. Разрешения на инструкции, главы и страницы перезапишут эти разрешения.',
