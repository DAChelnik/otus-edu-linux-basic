...
return [
    ...
    'bookshelf_not_found' => 'Раздел не найден',
    'book_not_found' => 'Инструкция не найдена',
    'page_not_found' => 'Страница не найдена',
    'chapter_not_found' => 'Глава не найдена',
    'selected_book_not_found' => 'Выбранная инструкция не найдена',
    'selected_book_chapter_not_found' => 'Выбранная инструкция или глава не найдена',
